...
public class KafkaConfig {
    ...
    @Bean
    public ProducerFactory<String, OtpMessage> producerFactory() {
    ...
    @Bean
    public KafkaTemplate<String, OtpMessage> kafkaTemplate() {
    ...
    public ConsumerFactory<String, OtpMessage> consumerFactory() {
        ...
        configProps.put(ConsumerConfig.GROUP_ID_CONFIG, "otp-group");
        configProps.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        configProps.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, JsonDeserializer.class);
        configProps.put(JsonDeserializer.TRUSTED_PACKAGES, "com.yourpackage"); // adjust package
        return new DefaultKafkaConsumerFactory<>(configProps, new StringDeserializer(),
                new JsonDeserializer<>(OtpMessage.class));
    }
